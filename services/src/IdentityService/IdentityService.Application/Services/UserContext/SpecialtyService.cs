...
public class SpecialtyService : ISpecialtyService
{
    ...
    public async Task<Specialty?> GetSpecialtyById(
        int id,
        CancellationToken cancellationToken = default
    )
    {
    ...
    public async Task<Specialty> CreateSpecialty(
        string title,
        CancellationToken cancellationToken = default
    )
    {
    ...
    public async Task<bool> UpdateSpecialty(
        int specialtyId,
    ...
    public async Task<bool> DeleteSpecialty(
        int specialtyId,
        CancellationToken cancellationToken = default
    )
    {
