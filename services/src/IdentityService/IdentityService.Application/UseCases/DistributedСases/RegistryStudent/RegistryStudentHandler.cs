...
public class RegistryStudentHandler : IRequestHandler<RegistryStudentCommand, Result<AccountCreated>>
{
    ...
    public async Task<Result<AccountCreated>> Handle(RegistryStudentCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            Account accountResult =
                await _accountService.CreateStudentAccount(request.Email, request.Password, cancellationToken);

            User userResult =
                await _userService.CreateStudent(
