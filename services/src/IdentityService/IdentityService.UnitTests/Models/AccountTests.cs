...
public class AccountTests
{
    private readonly Mock<IPasswordHasher> _passwordHasherMock;
        ...
        {
            // Act
            Action act = () => Account.CreateStudentAccount("user@test.com", "123", _passwordHasherMock.Object);

            // Assert
            act.Should().Throw<DomainException>()
               .WithMessage("*не меньше 4*");
        }
        ...
        {
            // Act
            Action act = () => Account.Restore(Guid.Empty, "user@test.com", "HASHED_1234", DateTime.UtcNow, Role.User);
        ...
        {
            // Act
            Action act = () => Account.Restore(Guid.NewGuid(), "", "HASHED_1234", DateTime.UtcNow, Role.User);
