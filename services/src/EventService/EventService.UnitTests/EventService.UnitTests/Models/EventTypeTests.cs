...
public class EventTypeTests
{
    ...
    {
        Assert.Throws<DomainException>(() => EventType.Create(""));
    }

    [Fact]
    public void Create_Should_Throw_When_Title_Too_Short()
    {
        Assert.Throws<DomainException>(() => EventType.Create("К"));
    }
    ...
    public void Create_Should_Throw_When_Title_Too_Long()
    {
        ...
        Assert.Throws<DomainException>(() => EventType.Create(title));
    }
    ...
    public void UpdateEventType_Should_Throw_When_Title_Too_Short()
    {
        ...
        Assert.Throws<DomainException>(() => eventType.UpdateEventType("a"));
    }
