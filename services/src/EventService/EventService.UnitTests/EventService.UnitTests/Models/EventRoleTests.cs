...
public class EventRoleTests
{
    ...
    [InlineData(
        "ОченьДлинноеНазваниеКотороеПревышает35Символов",
        "Описание корректное длиной более 15 символов"
    )]
    ...
    [InlineData(
        "Орг",
        "Очень длинное описание, которое значительно превышает допустимый лимит в семьдесят пять символов и не должно пройти валидацию."
    )]
