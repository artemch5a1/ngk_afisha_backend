...
public class EventTypeService : IEventTypeService
{
    ...
    public async Task<EventType?> GetEventTypeById(
        int typeId,
        CancellationToken cancellationToken = default
    )
    {
    ...
    public async Task<EventType> CreateEventType(
        string title,
        CancellationToken cancellationToken = default
    )
    {
    ...
    public async Task<bool> UpdateEventType(
        int typeId,
        string title,
        CancellationToken cancellationToken = default
    )
    ...
    public async Task<bool> DeleteEventType(
        int typeId,
        CancellationToken cancellationToken = default
    )
    {
