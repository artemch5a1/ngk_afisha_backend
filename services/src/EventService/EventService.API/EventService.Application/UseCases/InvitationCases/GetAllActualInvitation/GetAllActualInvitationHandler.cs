...
public class GetAllActualInvitationHandler : IRequestHandler<GetAllActualInvitationQuery, Result<List<Invitation>>>
{
    ...
    public async Task<Result<List<Invitation>>> Handle(GetAllActualInvitationQuery request, CancellationToken cancellationToken)
    {
        try
        {
            List<Invitation> invitations =
                await _invitationService.GetAllActualInvitation(request.Contract, cancellationToken);
