...
{
    Task<List<Event>> GetAllEvent(ISpecification<Event>? specification, PaginationContract? contract = null,
        CancellationToken cancellationToken = default);
    
    Task<bool> IsEventsExist(CancellationToken cancellationToken = default);
    
    Task<List<Event>> GetAllEvent(PaginationContract? contract = null, CancellationToken cancellationToken = default);
    
    Task<List<Event>> GetAllEventByAuthorId(Guid authorId, PaginationContract? contract = null, CancellationToken cancellationToken = default);
