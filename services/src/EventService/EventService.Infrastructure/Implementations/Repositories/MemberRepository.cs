...
public class MemberRepository : IMemberRepository
{
    ...
    public async Task<List<Member>> GetAll(PaginationContract? contract = null, CancellationToken cancellationToken = default)
    {
        try
        {
    ...
    public async Task<Member?> GetById((Guid invitationId, Guid studentId) id, CancellationToken cancellationToken = default)
    {
        try
        {
            MemberEntity? memberEntity =
                await _db.Members
                    ...
                    .FirstOrDefaultAsync(x => 
                        x.InvitationId == id.invitationId && x.StudentId == id.studentId, 
                        cancellationToken);
    ...
    public async Task<Member?> FindAsync((Guid invitationId, Guid studentId) id, CancellationToken cancellationToken = default)
    {
        try
        {
            MemberEntity? memberEntity =
                await _db.Members
                    .FindAsync(id.invitationId, id.studentId, 
                        cancellationToken);
    ...
    public async Task<List<Member>> GetAllByAuthor(Guid authorId, PaginationContract? contract = null, CancellationToken cancellationToken = default)
    {
        try
        {
            List<MemberEntity> entities =
    ...
    public async Task<List<Member>> GetAllByStudent(Guid studentId, PaginationContract? contract = null,
