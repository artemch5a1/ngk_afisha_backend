...
public class EventMapper : IEntityMapper<EventEntity, Event>
{
    ...
    private void AddInvitationNavigation(ref Event domain, ICollection<InvitationEntity> invitationsEntities)
    {
        ...
        foreach (var t in invitations)
        {
            ...
            InvitationEntity invitationEntity =
                invitationsEntities.First(x => x.InvitationId == invitation.InvitationId);
    ...
    private void AddMemberNavigation(ref Invitation domain, ICollection<MemberEntity> memberEntities)
    {
